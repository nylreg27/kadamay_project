    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('individual', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments_as_payee', to='individual.individual')),
            ],
            options={
                'verbose_name': 'Payee',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt_number', models.CharField(blank=True, help_text='Official Receipt (OR) number or internal reference. Auto-generated for new payments (YY-NNNN format).', max_length=100, null=True)),
                ...
                ('payment_status', models.CharField(choices=[('PENDING_VALIDATION', 'Pending Validation'), ('VALIDATED', 'Validated'), ('CANCELLED', 'Cancelled'), ('DRAFT', 'Draft'), ('COMPLETED', 'Completed'), ('LEGACY', 'Legacy Record')], default='PENDING_VALIDATION', help_text='Current status of the payment (e.g., Pending Validation, Validated, Cancelled, Legacy).', max_length=20)),
                ('gcash_reference_number', models.CharField(blank=True, help_text='Reference number for GCash transactions (e.g., transaction ID).', max_length=100, null=True)),
                ...
                ('covered_members', models.ManyToManyField(blank=True, help_text='Individuals covered by this payment, with specific allocated amounts.', related_name='payments_covered', through='payment.Payee', to='individual.individual')),
                ...
                ('deceased_member', models.ForeignKey(blank=True, help_text="If this payment is for a deceased member's contribution.", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments_for_deceased', to='individual.individual')),
                ('individual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments', to='individual.individual')),
                ...
                ('validated_by', models.ForeignKey(blank=True, help_text='Admin/Cashier who validated the payment.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments_validated', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='payee',
            name='payment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payees', to='payment.payment'),
        ),
