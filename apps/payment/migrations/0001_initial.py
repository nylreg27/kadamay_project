# Generated by Django 4.2.23 on 2025-06-19 01:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt_number', models.CharField(blank=True, help_text='Official Receipt (OR) number or internal reference.', max_length=100, null=True)),
                ...
                ('series_prefix', models.CharField(blank=True, help_text="Custom series prefix for the receipt number (e.g., 'KDM-'). If left blank, a date-based prefix 'OR-YYYY-MM-' will be used.", max_length=50, null=True)),
